...
#SBATCH --gres=gpu:3             # Use GPU if supported by the code
#SBATCH --time=72:00:00          # Set the job to 1 hour max
#SBATCH --partition=h100         # h100 or 140s
#SBATCH --output=/home/jiaxu/projects/sp-mdm/job_train_output_chronacc.log
#SBATCH --error=/home/jiaxu/projects/sp-mdm/job_train_error_chronacc.log
...
python -m train.train_mdm --save_dir save/chronacc_my_humanml_trans_enc_512 --dataset humanml --eval_during_training